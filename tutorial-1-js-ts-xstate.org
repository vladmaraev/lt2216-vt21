...
|---+------------------------------------------+------------+------------------|
| 1 | [[lab1.org][Basic dialogue management]]                | 22/1 & 5/2 | 15/2             |
| 2 | NLU for dialogue systems                 | see Canvas | see Canvas       |
...
- NodeJS :: [[https://nodejs.org/en/download/][download and install NodeJS]]
...
1. Many systems on the market are proprietary: the code is either not
   available (Dialogue Flow) or one need to look how things are
...
*** Grammar
- comments: ~//~ (or ~/* */~)
- reserved words can’t be used as variables or even objest properties
  #+begin_example
  abstract
  boolean break byte
